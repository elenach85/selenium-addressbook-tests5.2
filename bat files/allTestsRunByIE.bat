...
cd /d %ProjectPath%
set IEDriverPath=D:\PDT\IEDriverServer.exe
...
java -cp bin;%SeleniumPath%;%IEDriverPath%;%MySqlPath%;%kxml2Path%;%XstreampullPath%;%HibernatejbosstransactionPath%;%HibernatejmsPath%;%HibernatejbossannotationsPath%;%HibernatejpaPath%;%HibernatexmlapisPath%;%HibernatelucenePath%;%HibernatejbossloggingPath%;%HibernatejavaassistPath%;%HibernatecorefilePath%;%HibernatedomfilePath%;%HibernatecommonannotationsfilePath%;%HibernateantlrfilePath%;%XstreamfilePath%;%Xstreamxpp3filePath% -Dwebdriver.ie.driver=%IEDriverPath% -DconfigFile=ie.properties org.testng.TestNG testng-customsuite.xml
